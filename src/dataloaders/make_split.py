...
Defaults to taking ALL train_NN.json files in --shards_dir, randomly shuffling, then taking --n_test for test, the rest for train.

Output: a small JSON manifest recording the split. Both src.train.train_mvp_wa_wh andsrc.eval.eval_tom_model accept --split_manifest pointing at this file.
